...
SYNTHETIC_WARNING = (
    "\n" + "!" * 70 + "\n"
    "  WARNING: SYNTHETIC DATA — NOT EVIDENCE OF A REAL EDGE.\n"
    "  Prices here are generated by a stochastic process, not real markets, and\n"
    "  the universe is survivorship-biased (hand-picked 2026 winners, several of\n"
    "  which did not trade for most of the window). Treat as a directional\n"
    "  sanity check only. See REVIEW_AND_IMPROVEMENTS.md §2.2.\n"
    + "!" * 70 + "\n"
)
...
def run_backtest():
    ...
    results = {
        ...
        "synthetic_data": True,
        "trust_warning": (
            "SYNTHETIC DATA + survivorship-biased universe — directional sanity "
            "check only, not evidence of a real edge. See "
            "REVIEW_AND_IMPROVEMENTS.md §2.2."
        ),
